        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">{{ __('Registrasi Dosen') }}</h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('dosen.register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="nidn" type="text" class="form-control @error('nidn') is-invalid @enderror" name="nidn" value="{{ old('nidn') }}" required>
                                @error('nidn')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="pendidikan_terakhir" type="text" class="form-control @error('pendidikan_terakhir') is-invalid @enderror" name="pendidikan_terakhir" value="{{ old('pendidikan_terakhir') }}" required>
                        ...
                        <div class="row mb-3">
                            <label for="tahun_bergabung" class="col-md-4 col-form-label text-md-end">{{ __('Tahun Bergabung') }}</label>
                            <div class="col-md-6">
                                <input id="tahun_bergabung" type="number" class="form-control @error('tahun_bergabung') is-invalid @enderror" name="tahun_bergabung" value="{{ old('tahun_bergabung') }}" min="1980" max="{{ date('Y') }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="bidang_keahlian" type="text" class="form-control @error('bidang_keahlian') is-invalid @enderror" name="bidang_keahlian" value="{{ old('bidang_keahlian') }}">
