        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">{{ __('Registrasi Mahasiswa') }}</h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('mahasiswa.register') }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <h5 class="text-primary">Data Mahasiswa</h5>
                                <hr>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="tahun_masuk" type="number" class="form-control @error('tahun_masuk') is-invalid @enderror" name="tahun_masuk" value="{{ old('tahun_masuk') }}" min="2000" max="{{ date('Y') }}" required>
                                @error('tahun_masuk')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
