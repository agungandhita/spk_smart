            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">
                        <i class="fas fa-edit me-2"></i>Edit Data Nilai KHS/IPK - Semester {{ $nilai->semester }}
                    </h4>
                </div>
                <div class="card-body">
                    <!-- Info Mahasiswa -->
                    ...
                    <form action="{{ route('mahasiswa.nilai.update', $nilai->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('semester') is-invalid @enderror" 
                                    ...
                                    @foreach($semesterList as $key => $value)
                                        <option value="{{ $key }}" 
                                                {{ (old('semester', $nilai->semester) == $key) ? 'selected' : '' }}>
                                            {{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       id="sks_semester" 
                                       name="sks_semester" 
                                       value="{{ old('sks_semester', $nilai->sks_semester) }}" 
                                       min="1" 
                                       max="30" 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       id="sks_kumulatif" 
                                       name="sks_kumulatif" 
                                       value="{{ old('sks_kumulatif', $nilai->sks_kumulatif) }}" 
                                       min="1" 
                                    ...
                                    <div class="mb-2">
                                        <div class="alert alert-success py-2">
                                            ...
                                            <a href="{{ route('mahasiswa.nilai.download', $nilai->id) }}" 
                                               class="alert-link" 
                                               target="_blank">
                                                KHS_Semester_{{ $nilai->semester }}.pdf
                                            </a>
                                        </div>
                                    </div>
                                @endif
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('keterangan') is-invalid @enderror" 
                                          ...
                                          name="keterangan" 
                                          rows="3" 
                                          placeholder="Catatan tambahan (opsional)">{{ old('keterangan', $nilai->keterangan) }}</textarea>
                                @error('keterangan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        <a href="{{ route('mahasiswa.nilai.show', $nilai->id) }}" class="btn btn-info me-2">
                                            <i class="fas fa-eye me-1"></i>Lihat Detail
                                        </a>
                                        <button type="submit" class="btn btn-primary">
                                            <i class="fas fa-save me-1"></i>Update Data Nilai
                                        </button>
                                    </div>
                                </div>
                            </div>
