...
@section('title', 'Tambah Topik Skripsi')
...
<div class="page-header bg-gradient-primary text-white py-4 mb-4">
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col">
                <h1 class="h3 mb-1">Tambah Topik Skripsi Baru</h1>
                <p class="mb-0 opacity-75">Buat topik skripsi baru untuk mahasiswa bimbingan</p>
            </div>
            <div class="col-auto">
                <a href="{{ route('dosen.topik-skripsi.index') }}" class="btn btn-light">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white border-bottom">
            <h5 class="card-title mb-0">
                ...
                Form Tambah Topik Skripsi
            </h5>
        </div>
        <div class="card-body p-4">
                    <form action="{{ route('dosen.topik-skripsi.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control form-control-lg @error('judul') is-invalid @enderror"
                                   ...
                                   placeholder="Masukkan judul skripsi yang jelas dan spesifik" required>
                            @error('judul')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('deskripsi') is-invalid @enderror"
                                      ...
                                      placeholder="Deskripsi singkat tentang topik skripsi, tujuan, dan ruang lingkup penelitian...">{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <!-- Bidang Keahlian -->
                        <div class="mb-4">
                            <label for="bidang_keahlian" class="form-label font-weight-bold">
                            ...
                            <input type="text" class="form-control @error('bidang_keahlian') is-invalid @enderror"
                                   ...
                                   placeholder="Contoh: Sistem Informasi, Jaringan Komputer, Machine Learning">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="nama_mahasiswa" class="form-label font-weight-bold">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="nim_mahasiswa" class="form-label font-weight-bold">
                                            NIM Mahasiswa <span class="text-danger">*</span>
                                        </label>
                                        <input type="text" class="form-control @error('nim_mahasiswa') is-invalid @enderror"
                                               id="nim_mahasiswa" name="nim_mahasiswa" value="{{ old('nim_mahasiswa') }}" 
                        ...
                        <!-- Kata Kunci -->
                        <div class="mb-4">
                            <label for="kata_kunci" class="form-label font-weight-bold">
                            ...
                            <input type="text" class="form-control @error('kata_kunci') is-invalid @enderror"
                                   ...
                                   placeholder="Pisahkan dengan koma, contoh: web development, database, machine learning">
                            <div class="form-text">
                                <i class="fas fa-info-circle mr-1"></i>
                                Kata kunci untuk memudahkan pencarian (opsional)
                            </div>
                            @error('kata_kunci')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card bg-gradient-light border-0 shadow-sm mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-2">
                                    ...
                                    <div class="font-weight-bold">{{ $dosen->user->name }}</div>
                                </div>
                                <div class="mb-2">
                                    <small class="text-muted">NIDN</small>
                                    <div class="font-weight-bold">{{ $dosen->nidn }}</div>
                                </div>
                                <div class="mb-2">
                                    <small class="text-muted">Program Studi</small>
                                    <div class="font-weight-bold">{{ $dosen->prodi }}</div>
                                </div>
                                <div class="mb-0">
                                    <small class="text-muted">Fakultas</small>
                                    <div class="font-weight-bold">{{ $dosen->fakultas }}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <label for="file_pdf" class="form-label font-weight-bold">
                                        File PDF Skripsi <span class="text-danger">*</span>
                                    </label>
                                 ...
                                 <div id="filePreview" class="d-none">
                                     <div class="alert alert-success border-0 shadow-sm">
                                         <div class="d-flex align-items-center">
                                             ...
                                             <div>
                                                 <div id="fileName" class="font-weight-bold small"></div>
                 ...
                 <div class="d-flex justify-content-between align-items-center">
                     ...
                     <div class="btn-group">
                         <a href="{{ route('dosen.topik-skripsi.index') }}" class="btn btn-outline-secondary">
                             <i class="fas fa-times mr-2"></i>Batal
                         </a>
                         <button type="submit" class="btn btn-primary">
                             <i class="fas fa-save mr-2"></i>Simpan Topik Skripsi
                         </button>
                     </div>
                 </div>
                </form>
